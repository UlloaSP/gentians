...
class Solver:
    ...
    def solve(self) -> None:
        ...
        sampler = ProgramSampler(
            self.program.language_bias_head,
            self.program.language_bias_body,
            self.arguments,
        )
        ...
        try:
            with phase("total_execution"):
                for it in range(self.arguments.iterations):
                    ...
                    with phase("sampling"):
                        cls = sampler.sample_clauses_stub(
                            self.arguments.clauses_to_sample
                        )
                    ...
                    current_strategy = Strategy(
                        placed_list_improved, self.program, self.arguments
                    )
