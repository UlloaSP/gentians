% Generated by benchmarks/export_ilasp_aggregates.py from hamming_0_unbalanced.txt.
% Source SHA256 (UTF-8, LF): 1c70cf65d7bab0b96bb87314afd48d7107dcf43480ef77c68f334b43791bff17
...
2 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V0:d(V1,V0)}=V2.
3 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V0:d(V1,V0)}=V3,V2-V3!=0.
2 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V0:d(V3,V0)}=V2.
2 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V1:d(V0,V1)}=V2.
3 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V1:d(V0,V1)}=V3,V2-V3!=0.
2 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V1:d(V3,V1)}=V2.
2 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V3:d(V0,V3)}=V2.
2 ~ :- #sum{V0:d(V1,V0)}=V2,#count{V3:d(V1,V3)}=V2.
3 ~ :- hd(V0),#count{V0:d(V1,V0)}=V2,V0-V2!=0.
2 ~ :- hd(V0),#count{V1:d(V2,V1)}=V0.
3 ~ :- hd(V0),#count{V1:d(V2,V1)}=V3,V0-V3!=0.
3 ~ :- hd(V0),#sum{V0:d(V1,V0)}=V2,#count{V0:d(V1,V0)}=V2.
3 ~ :- hd(V0),#sum{V0:d(V1,V0)}=V2,#count{V0:d(V3,V0)}=V2.
3 ~ :- hd(V0),#sum{V0:d(V1,V0)}=V2,#count{V1:d(V3,V1)}=V2.
3 ~ :- hd(V0),#sum{V0:d(V1,V0)}=V2,#count{V3:d(V1,V3)}=V2.
3 ~ :- hd(V0),#sum{V0:d(V1,V0)}=V2,V0-V2!=0.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V0,#count{V1:d(V2,V1)}=V0.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V0,#count{V1:d(V3,V1)}=V0.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V0,#count{V2:d(V1,V2)}=V0.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V0,#count{V2:d(V3,V2)}=V0.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V0,#count{V3:d(V1,V3)}=V0.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V0,#count{V3:d(V2,V3)}=V0.
2 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V0.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V3,#count{V0:d(V1,V0)}=V3.
3 ~ :- hd(V0),#sum{V1:d(V2,V1)}=V3,#count{V0:d(V2,V0)}=V3.
