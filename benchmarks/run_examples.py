...
EXAMPLES: dict[str, Arguments] = {
    ...
    "adjacent_to_red": task("adjacent_to_red.txt", max_depth=4, verbosity=1),
    "clique": task(
        "clique.txt",
        max_depth=7,
    ...
    "coin": task("coin.txt", verbosity=1),
    "coloring": task(
        "coloring.txt",
    ...
    "even_odd": task("even_odd.txt", verbosity=1),
    "grandparent": task("grandparent.txt", verbosity=1),
