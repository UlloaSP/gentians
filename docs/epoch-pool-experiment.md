...
actual se llama `incremental_clause_genetic_search`; su bucle vive
en `gentians/algorithms/incremental_clause_genetic.py` y delega lotes, candidatos,
población y métricas en los módulos `incremental_*` del mismo paquete. La evaluación persistente
